...
- **Pipeline Abstraction**: The library centers on return-value `IPipeline<TInput, TOutput>`. Destination buffer execution uses `IDestinationPipeline<TInput, TOutput>`.
