...
public sealed record PooledExecutorOptions<TConfig>(TConfig ExecutorConfig, int ExecutorCount) : IModelExecutorOptions where TConfig : new()
{
    public PooledExecutorOptions() : this(new(), 0) { }
}
