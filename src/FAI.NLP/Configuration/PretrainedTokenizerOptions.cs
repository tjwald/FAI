...
/// <param name="IncludeTokenTypeIds">Whether to include a zero-filled token type IDs tensor in batch tensorization.</param>
public sealed record PretrainedTokenizerOptions(
    int PaddingToken = 0,
    int MaxTokenLength = 512,
    TruncationOption TruncationOption = TruncationOption.Longest,
    bool IncludeTokenTypeIds = false);
